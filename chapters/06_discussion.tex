...
contract is read --- but a router-disabled M1 ablation would be required to
...
The benchmark $F_2$ ranking therefore does not translate directly into
``deploy single-agent in production'': on the one production-relevant axis the
benchmark does measure, multi-agent dominates.
